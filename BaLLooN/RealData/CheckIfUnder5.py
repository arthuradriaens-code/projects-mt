...
directory = os.fsencode('/media/RNO-G/data/sonde/gpx/')
with open('EventsBelow5Deg.csv', 'w', newline='') as csvfile:
    ...
    # Add, markers to the gps-locations of the detectors
                ...
                the_map
    # To save the map:
                the_map.save('maps5/map_{}_{}.html'.format(filename,StationNumber))
