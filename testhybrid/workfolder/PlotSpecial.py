...
plt.xlim(0,1.2)
plt.ylim(0.6,1.8)
plt.scatter(z_60P,s_60P,color='grey')
plt.scatter(z_70P,s_70P,color='grey')
plt.scatter(z_80P,s_80P,color='grey')
plt.scatter(z_10P,s_10P,color='grey')
plt.scatter(z_15P,s_15P,color='grey')
plt.scatter(z_20P,s_20P,color='grey')
plt.scatter(z_25P,s_25P,color='grey')
plt.scatter(z_30P,s_30P,color='grey')
plt.scatter(z_35P,s_35P,color='grey')
plt.scatter(z_45P,s_45P,color='grey')
plt.scatter(z_40P,s_40P,color='grey')
plt.scatter(z_50P,s_50P,color='green',label='Sphere size= 50m')
...
plt.scatter(z_60P,s_60P,color='green',label='Sphere size= 60m')
...
plt.scatter(z_70P,s_70P,color='green',label='Sphere size= 70m')
...
plt.scatter(z_80P,s_80P,color='green',label='Sphere size= 80m')
...
plt.scatter(z_10P,s_10P,color='green',label='Sphere size= 10m')
...
plt.scatter(z_15P,s_15P,color='green',label='Sphere size= 15m')
...
plt.scatter(z_20P,s_20P,color='green',label='Sphere size= 20m')
...
plt.scatter(z_25P,s_25P,color='green',label='Sphere size= 25m')
...
plt.scatter(z_30P,s_30P,color='green',label='Sphere size= 30m')
...
plt.scatter(z_35P,s_35P,color='green',label='Sphere size= 35m')
...
plt.scatter(z_45P,s_45P,color='green',label='Sphere size= 45m')
circle1 = plt.Circle((0.7,0.75), 0.05, color='b', fill=False)
...
plt.scatter(z_40P,s_40P,color='green',label='Sphere size= 40m')
