...
sed "s/StepsZenith = .*/StepsZenith = 1.15/g" compare_both.py > .tempfile 
cat .tempfile > compare_both.py && rm .tempfile
echo -n "1.15	" >> comparesteps
python compare_both.py
cat hybrid_sigmas >> comparesteps

sed "s/StepsZenith = .*/StepsZenith = 1.20/g" compare_both.py > .tempfile 
cat .tempfile > compare_both.py && rm .tempfile
echo -n "1.20	" >> comparesteps
python compare_both.py
cat hybrid_sigmas >> comparesteps

sed "s/StepsZenith = .*/StepsZenith = 1.25/g" compare_both.py > .tempfile 
cat .tempfile > compare_both.py && rm .tempfile
echo -n "1.25	" >> comparesteps
python compare_both.py
cat hybrid_sigmas >> comparesteps
...
sed "s/StepsZenith = .*/StepsZenith = 1.3/g" compare_both.py > .tempfile 
cat .tempfile > compare_both.py && rm .tempfile
echo -n "1.3	" >> comparesteps
python compare_both.py
cat hybrid_sigmas >> comparesteps

sed "s/StepsZenith = .*/StepsZenith = 1.35/g" compare_both.py > .tempfile 
cat .tempfile > compare_both.py && rm .tempfile
echo -n "1.35	" >> comparesteps
python compare_both.py
cat hybrid_sigmas >> comparesteps

sed "s/StepsZenith = .*/StepsZenith = 1.4/g" compare_both.py > .tempfile 
cat .tempfile > compare_both.py && rm .tempfile
echo -n "1.4	" >> comparesteps
python compare_both.py
cat hybrid_sigmas >> comparesteps
