...
def choose(IceModelChoice,InputFile,DetectorDescription,Config,OutputFileName):
    if IceModelChoice == 1:
        print("you chose to run the greenland firn ice model")
        return 'greenland_firn'
    elif IceModelChoice == 2:
        print("you chose to run the greenland_simple ice model")
        return 'greenland_simple'
    elif IceModelChoice == 3:
        print("you chose to run the southpole_2015 ice model")
        return 'southpole_2015'
    elif IceModelChoice == 4:
        print("you chose to run the southpole_simple ice model")
...
if __name__ == "__main__":
    ...
    parser.add_argument('IceChoice', type=int, help="Which ice model would you like to run? The possible choices are\n\
    Gorham ice model  (1)\n\
    Exponential model (2)\n\
    wrong entry model (3)\n\
    :")
    ...
    iceModel = choose(args.IceChoice,args.inputfilename,args.detectordescription,args.config,args.outputfilename)
    ...
    sim = mySimulation(inputfilename=args.inputfilename,
                                ...
                                file_overwrite=True,
                                ice_model=medium.get_ice_model(iceModel))
    sim.run()
